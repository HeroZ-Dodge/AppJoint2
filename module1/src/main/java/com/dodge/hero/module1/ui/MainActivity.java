...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_app_module_method).setOnClickListener(v -> mAppRouter.method1(this));
        findViewById(R.id.btn_app_module_page).setOnClickListener(v -> mAppRouter.startPage(this));
